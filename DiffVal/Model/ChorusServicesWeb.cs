...
{
    public class ChorusServicesWeb
    {
        //	Identifiant	RaisonSociale	Code	Nom	GestionEGMT	ServiceActif	Adresse	ComplementAdresse1	ComplementAdresse2	CodePostal	Ville	NumTelephone	Courriel	CodePays	LibellePays
        ...
        public ChorusServicesWeb(string Identifiant,
        ...
        public string ToWebCSVString(string separator)
        {
            return $"{Identifiant}{separator}{RaisonSociale}{separator}{Code}{separator}{Nom}{separator}{GestionEGMT}{separator}{ServiceActif}{separator}{Adresse}{separator}{ComplementAdresse1}{separator}{ComplementAdresse2}{separator}{CodePostal}{separator}{Ville}{separator}{NumTelephone}{separator}{Courriel}{separator}{CodePays}{separator}{LibellePays}";
        }
    }
}
